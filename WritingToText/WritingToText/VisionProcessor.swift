...
struct VisionProcessor {
    ...
    func detectText(completion: @escaping (EncryptData?) -> Void) {
        ...
        let request = VNRecognizeTextRequest { request, error in
            ...
            completion(EncryptData(rects: boundingRects, lineRects: lineBoundingRects, texts: texts, lines: lines)) // Return array of rectangles and texts
        }
...
struct EncryptData{
    ...
    init(rects: [CGRect], lineRects: [CGRect], texts: [String], lines: [String]){
        self.rects = rects
        self.texts = texts
        self.lines = lines
